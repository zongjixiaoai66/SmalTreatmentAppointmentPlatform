...
public class YishengOrderView extends YishengOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 支付类型的值
		*/
		private String yishengOrderPaymentValue;
	...
	public YishengOrderView(YishengOrderEntity yishengOrderEntity) {
		try {
			...
			* 获取： 支付类型的值
			*/
			public String getYishengOrderPaymentValue() {
				return yishengOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setYishengOrderPaymentValue(String yishengOrderPaymentValue) {
				this.yishengOrderPaymentValue = yishengOrderPaymentValue;
			}
