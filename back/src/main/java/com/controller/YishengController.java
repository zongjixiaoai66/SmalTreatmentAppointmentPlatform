...
//                            yishengEntity.setYishengShanchang(data.get(0));                    //医生擅长 要改的
...
//                            yishengEntity.setGuahaofei(data.get(0));                    //挂号费 要改的
//                            yishengEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            yishengEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
...
//    	ValidatorUtils.validateEntity(user);
        ...
        yisheng.setCreateTime(new Date());
        yisheng.setZanNumber(0);
        yisheng.setCaiNumber(0);
        yishengService.insert(yisheng);
        return R.ok();
    }
