    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yishengCollection !=null){
            ...
            BeanUtils.copyProperties( yishengCollection , view );//把实体数据重构到view中
                ...
                //级联表
                HuanzheEntity huanzhe = huanzheService.selectById(yishengCollection.getHuanzheId());
                if(huanzhe != null){
    ...
    */
    ...
    public R save(@RequestBody YishengCollectionEntity yishengCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            yishengCollection.setHuanzheId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<YishengCollectionEntity> queryWrapper = new EntityWrapper<YishengCollectionEntity>()
            ...
            .eq("huanzhe_id", yishengCollection.getHuanzheId())
...
//                            yishengCollectionEntity.setHuanzheId(Integer.valueOf(data.get(0)));   //患者 要改的
